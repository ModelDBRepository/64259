...
An extended analytic expression for the membrane potential distribution of conductance-based synaptic noise. *Neural Comput* 17:2301-15
...
To run the demo, simply auto-launch from ModelDB, or unzip this file, compile the mod file mechanism and execute the file `demo.hoc`.
